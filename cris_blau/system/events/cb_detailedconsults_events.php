<?php
    ...
    $taxa_entrada_explode = explode('.', $sql_sel_events_dados['entry_fee']);

    $taxa_entrada = "R$".$taxa_entrada_explode[0].",".$taxa_entrada_explode[1];
    ...
    if($contadora_kit==0){
        $resultado_k2 = '<tr><td>Não há kits!</td></tr>';
    }else{
    ...
    $contadora_item = $sql_sel_events_has_items_preparado->rowCount();
    ...
    if($contadora_item==0){
        $resultado_i2 = '<tr><td>Não há itens!</td></tr>';
    }else {
