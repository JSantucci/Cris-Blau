<?php
    ...
    //Estas linhas são responsáveis por receber o cliente, kits, quantidade dos kits, itens, quantidade de itens, local, cep, cidade, bairro, logradouro, numero, complemento, data do evento, horário, taxa de entrega, valor real, desconto, valor final e observação da fmins via POST.
    if($p_desconto==""){
        $descontob = 0;
    }else{
        $descontob = str_replace('.',',', $p_desconto);
    }

    if($p_taxa_entrega==""){
        $taxa_entregab = 0;
    }else{
        $taxa_entregab = str_replace('.',',', $p_taxa_entrega);
    }
                                                                ...
                                                                $mensagem = mensagens("Validação", "Data do Evento");
                                                                    ...
                                                                    $mensagem = mensagens("Validação Data");
                                                                        ...
                                                                        $mensagem = "A data escolhida já passou!";
                                                                            ...
                                                                            $mensagem = mensagens("Validação", "Horário");
                                                                                                        ...
                                                                                                        $mensagem = mensagens("Validação Numerico", "Desconto");
                                                                                                            ...
                                                                                                            $mensagem = mensagens("Validação", "Valor Final");
                                                                                                                ...
                                                                                                                if(($p_local!="cliente") && ($p_local!="outro")){
                                                                                                                    ...
                                                                                                                    $sql_sel_events = "SELECT id, locals_id, event_date FROM events WHERE locals_id='".$local_empresa."' AND event_date='".$data_banco."'";
                                                                                                                ...
                                                                                                                /*//Esta estrutura é responsável por fazer a seleção do id, local e event_date da tabela events (eventos)... Onde o local for igual a vairável local_evento e event_date for igual a variável data_banco.
                                                                                                                $sql_sel_events = "SELECT id, local, event_date FROM events WHERE local='".$local_evento."' AND event_date='".$data_banco."'";
                                                                                                                $sql_sel_events_preparado = $conexaobd->prepare($sql_sel_events);
                                                                                                                $sql_sel_events_preparado->execute();
                                                                                                                $sql_sel_events_dados = $sql_sel_events_preparado->fetch();*/
                                                                                                                ...
                                                                                                                if(($sql_sel_events_preparado != NULL && $sql_sel_events_preparado->rowCount()==0) || ($local_evento=='2')){
                                                                                                                    ...
                                                                                                                    for($i=0; $i<$kit_cont; $i++) {
                                                                                                                        ...
                                                                                                                        $sql_sel_kits = "SELECT kits.id, kits.name, kits_has_items.item_quantity AS kits_has_itemsitem_quantity, kits_has_items.items_id AS kits_has_itemsitems_id FROM kits INNER JOIN kits_has_items ON kits.id=kits_has_items.kits_id WHERE kits.id='" . $p_kits[$i] . "' GROUP BY kits_has_items.items_id";
                                                                                                                    ...
                                                                                                                    for($i=0; $i<$item_cont; $i++) {
                                                                                                                        ...
                                                                                                                        $sql_sel_items = "SELECT id, quantity FROM items WHERE id='".$p_itens[$i]."' GROUP BY id";
                                                                                                            ...
                                                                                                            if($mensagem == ""){
                                                                                                                ...
                                                                                                                //Chama a funçao adicionar e atribui o valor a variável sql_ins_events_resultado.

                                                                                                                //Este bloco é responsável por verificar se a inserção funcionou ou não.
                                                                                                                if($sql_ins_events_resultado){
                                                                                                                    $evento_id = $conexaobd->lastInsertId();
                                                                                                                    ...
                                                                                                                    if(($kit_validacao) && ($item_validacao)) {
                                                                                                                        ...
                                                                                                                        for ($i = 0; $i < $kit_cont; $i++) {
                                                                                                                            ...
                                                                                                                            $sql_ins_events_has_kits_resultado = adicionar($tabela, $dados);
                                                                                                                            //Chama a funçao adicionar e atribui o valor a variável sql_ins_events_has_kits_resultado.
                                                                                                                        }

                                                                                                                        //Este bloco é responsável por verificar se a inserção funcionou ou não.
                                                                                                                        if ($sql_ins_events_has_kits_resultado) {
                                                                                                                            for ($i = 0; $i < $item_cont; $i++) {
                                                                                                                                ...
                                                                                                                                $sql_ins_events_has_items_resultado = adicionar($tabela, $dados);
                                                                                                                                //Chama a funçao adicionar e atribui o valor a variável sql_ins_events_has_items_resultado.

                                                                                                                                //Este bloco é responsável por verificar se a inserção funcionou ou não.
                                                                                                                                if ($sql_ins_events_has_items_resultado) {
                                                                                                                                    $voltar = '';
                                                                                                                                    $msg_titulo = "Confirmação";
                                                                                                                                    $mensagem = mensagens("Sucesso", "Evento", "Cadastro");
                                                                                                                                } else {
                                                                                                                                    $mensagem = mensagens('Erro bd', 'evento', 'cadastrar');
                                                                                                                                }
                                                                                                                            }
                                                                                                                        } else {
                                                                                                                            $mensagem = mensagens('Erro bd', 'evento', 'cadastrar');
                                                                                                                ...
                                                                                                                <div class="message">
                                                                                                                    ...
                                                                                                                    <a href="?folder=events/&file=cb_fmins_events&ext=php"<?php echo $voltar; ?>><img src="../layout/images/back.png">Voltar</a>
                                                                                                                </div>
                                                                                                                <?php
                                                                                                            }else {
    ?>
