                                                            ...
                                                            $mensagem = mensagens("Validação Numerico", "número");
                                                                ...
                                                                $mensagem = mensagens("Validação", "valor do aluguel");
                                                                    ...
                                                                    $mensagem = mensagens("Validação Decimal", "valor do alguel");
                                                                        ...
                                                                        $sql_sel_locals = "SELECT * FROM locals WHERE name='".$p_nome."'";
                                                                        ...
                                                                        if($sql_sel_locals_preparado->rowCount()==0){
                                                                            ...
                                                                            if($sql_sel_items_resultado){
                                                                                ...
                                                                                $mensagem = mensagens("Sucesso", "local", "Registro");
                                                                            }else{
                                                                                $mensagem = mensagens("Erro bd", "local", "registar");
                                                                            }
...
<div class="message">
    ...
    <a href="?folder=locals/&file=cb_fmins_locals&ext=php"<?php echo $voltar;?>><img src="../layout/images/back.png">Voltar</a>
</div>
